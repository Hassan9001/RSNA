...
class AVM_TOFMRA_Data(Dataset):
    def __init__(self, root, split, fold=None, transform=None):
        super().__init__()
        self.split = split  # "train" | "val" | "test"
        self.img_dir = Path(root) / "nnsslPlans_onemmiso/Dataset004_AVM_TOFMRA/Dataset004_AVM_TOFMRA"
...
class AVM_TOFMRA_DataModule(BaseDataModule):
