...
class AVM_T1C_TOFMRA_Data(Dataset):
    def __init__(self, root, split, fold=None, transform=None):
        super().__init__()
        self.split = split  # "train" | "val" | "test"
        self.img_dir = Path(root) / "nnsslPlans_onemmiso/Dataset005_AVM_T1+C_TOFMRA/Dataset005_AVM_T1+C_TOFMRA"
...
class AVM_T1C_TOFMRA_DataModule(BaseDataModule):
