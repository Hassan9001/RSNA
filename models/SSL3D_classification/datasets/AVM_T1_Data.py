...
class AVM_T1_Data(Dataset):
    def __init__(self, root, split, fold=None, transform=None):
        super().__init__()
        self.split = split  # "train" | "val" | "test"
        self.img_dir = Path(root) / "nnsslPlans_onemmiso/Dataset002_AVM_T1/Dataset002_AVM_T1"
...
class AVM_T1_DataModule(BaseDataModule):
